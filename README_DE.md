...
REALMVOID ist ein Open-Source Cyberpunk-Noir Shared-Universe-Franchise, angesiedelt in der Megastadt Agnon City im Jahr 2226. Eine Welt aus zerfallender Infrastruktur, verbotener Technomancy und Erinnerungen, die sich weigern zu sterben.
...
- **Franchise Bible** — Die Regeln des Universums: drei Realitätsebenen, Technomancy, Fraktionen und die Philosophie, die alles zusammenhält.
- **Casefile Player** *(Tech-Demo)* — Eine browserbasierte Text-Adventure-Engine. Spiele Noir-Ermittlungsfälle in Agnon City. Keine Installation nötig. Zeigt das M7-Casefile-Format und die Layer/HEAT-Mechanik.
...
### Im Browser *(Tech-Demo)*
Öffne [`player/index.html`](player/index.html) in einem Browser — oder spiele direkt auf [realmvoid.com/player/](https://realmvoid.com/player/).

**Kein Server, kein Build, keine Installation nötig.** Eine einzelne HTML-Datei mit Vanilla JS.

> **Hinweis:** Der Casefile Player ist eine Tech-Demo, die das M7-JSON-Format demonstriert. Er zeigt, wie Casefiles funktionieren (Layer-Wechsel, HEAT-System, Branching), ist aber kein fertiges Produkt. Feedback und Beiträge sind willkommen.
...
3. **Interaktive Geschichte** — Triff Entscheidungen, navigiere durch die Realitätsebenen
...
**M4-Tags** — Optionale Technomancy-Fähigkeiten auf manchen Auswahlmöglichkeiten. Mächtig, aber riskant (kosten mehr HEAT).
...
**Technomancy** ist verbotene Software, die wie Magie wirkt — aber Spuren hinterlässt. Und dann ist da noch **Aurora** — eine vergessene Ära, an die sich niemand erinnern soll.
